Este proyecto se centra en la creación de un aplicación web de escritorio gracias a vue y node.js con javascript, además utiliza una base de datos no relacional como es NEO4j.
